# Contributing to CSRRrecon

Thank you for your interest in contributing to CSRRrecon! This guide covers everything you need to get started.
...
1. **Fork and clone** the repository:
   ...
   ```bash
   git clone https://github.com/<your-username>/CSRRrecon
   cd CSRRrecon
...
```
CSRRrecon/
├── CSRRrecon.sh              # Entry point (~536 lines) — arg parsing, module loading, dispatch
├── CSRRrecon.cfg             # Default configuration file
...
3. **Add a config toggle** in `CSRRrecon.cfg`:
...
2. Add configuration variables to `CSRRrecon.cfg`
...
- Group related variables together in `CSRRrecon.cfg`
...
3. **Integration Tests** — installs CSRRrecon and runs tool checks
...
Submit bugs via [GitHub Issues](https://github.com/six2dez/CSRRrecon/issues/new/choose). Include:

- CSRRrecon version (`git describe --tags`)
...
Open a [GitHub Issue](https://github.com/six2dez/CSRRrecon/issues/new/choose) with:
