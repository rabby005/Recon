...
<h1 align="center">
  <br>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://github.com/six2dez/CSRRrecon/blob/main/images/banner.png" alt="CSRRrecon"></a>
  <br>
  CSRRrecon
  <br>
</h1>
...
<p align="center">
  <a href="https://github.com/six2dez/CSRRrecon/releases/tag/v4.1"><img src="https://img.shields.io/badge/release-v4.1-2ea043?style=for-the-badge" alt="Release"></a>
  <a href="https://opensource.org/licenses/MIT"><img src="https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge" alt="License"></a>
  <a href="https://github.com/six2dez/CSRRrecon/issues?q=is%3Aissue+is%3Aclosed"><img src="https://img.shields.io/github/issues-closed-raw/six2dez/CSRRrecon.svg?style=for-the-badge" alt="Closed Issues"></a>
  ...
  <a href="https://t.me/joinchat/H5bAaw3YbzzmI5co"><img src="https://img.shields.io/badge/telegram-@CSRRrecon-26A5E4?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram"></a>
...
<p align="center">
  <a href="https://docs.CSRRrecon.com"><img src="https://img.shields.io/badge/GitBook-%23000000.svg?style=for-the-badge&logo=gitbook&logoColor=white" alt="Docs"></a>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/Bash%20Script-%23121011.svg?style=for-the-badge&logo=gnu-bash&logoColor=white" alt="Bash Script"></a>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/Linux-FCC624?style=for-the-badge&logo=linux&logoColor=black" alt="Linux"></a>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/macOS-000000?style=for-the-badge&logo=macos&logoColor=F0F0F0" alt="macOS"></a>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/github-%23121011.svg?style=for-the-badge&logo=github&logoColor=white" alt="GitHub"></a>
</p>

<p align="center">
  <a href="https://github.com/six2dez/CSRRrecon/actions"><img src="https://img.shields.io/badge/github_actions-%232671E5.svg?style=for-the-badge&logo=githubactions&logoColor=white" alt="GitHub Actions"></a>
  <a href="https://hub.docker.com/r/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/docker-%230db7ed.svg?style=for-the-badge&logo=docker&logoColor=white" alt="Docker"></a>
  <a href="https://github.com/six2dez/CSRRrecon/tree/main/Terraform"><img src="https://img.shields.io/badge/terraform-%23844FBA.svg?style=for-the-badge&logo=terraform&logoColor=white" alt="Terraform"></a>
  <a href="https://github.com/six2dez/CSRRrecon/tree/main/Terraform"><img src="https://img.shields.io/badge/ansible-%231A1918.svg?style=for-the-badge&logo=ansible&logoColor=white" alt="Ansible"></a>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/Go-00ADD8.svg?style=for-the-badge&logo=go&logoColor=white" alt="Go"></a>
  <a href="https://github.com/six2dez/CSRRrecon"><img src="https://img.shields.io/badge/Python-3776AB.svg?style=for-the-badge&logo=python&logoColor=white" alt="Python"></a>
</p>
...
**CSRRrecon** is a powerful automated reconnaissance tool designed for security researchers and penetration testers. It streamlines the process of gathering intelligence on a target by performing subdomain enumeration, vulnerability scanning, OSINT and more. With a modular design, extensive configuration options, and support for distributed scanning via AX Framework, CSRRrecon is built to deliver comprehensive results efficiently.

CSRRrecon leverages a wide range of techniques, including passive and active subdomain discovery, web vulnerability checks (e.g., XSS, SSRF, SQLi), OSINT, directory fuzzing, port scanning and screenshotting. It integrates with cutting-edge tools and APIs to maximize coverage and accuracy, ensuring you stay ahead in your reconnaissance efforts.
...
**Disclaimer:** Usage of CSRRrecon for attacking targets without prior consent is illegal. It is the user's responsibility to obey all applicable laws. The developers assume no liability for misuse or damage caused by this tool. Use responsibly.
...
CSRRrecon is packed with features to make reconnaissance thorough and efficient. Below is a detailed breakdown of its capabilities, updated to reflect the latest functionality in the script and configuration.
...
- **Docker Support**: Official Docker image on [DockerHub](https://hub.docker.com/r/six2dez/CSRRrecon).
...
- **AI Report Generation**: Generates reports using local AI models ([CSRRrecon_ai](https://github.com/six2dez/CSRRrecon_ai)).
...
CSRRrecon uses a modular architecture. The main entry point (`CSRRrecon.sh`) handles argument parsing and sources 8 specialized modules from the `modules/` directory.

### Directory Layout

```
CSRRrecon/
├── CSRRrecon.sh          # Entry point — arg parsing, module loading, dispatch
├── CSRRrecon.cfg         # Default configuration
...
The `--source-only` flag allows sourcing `CSRRrecon.sh` without executing the main logic, enabling unit testing of individual functions.

---

## 💿 Installation

CSRRrecon supports multiple installation methods to suit different environments. Ensure you have sufficient disk space (at least 10 GB recommended) and a stable internet connection.
...
```yaml
git clone https://github.com/six2dez/CSRRrecon
cd CSRRrecon
./install.sh --verbose
```
...
```bash
./CSRRrecon.sh -d example.com -r
```

3) Minimal run (passive-only footprint)

```bash
./CSRRrecon.sh -d example.com -p
```
...
1. **Prerequisites**:
   ...
   - **Golang**: Latest version (`install_golang` enabled by default in `CSRRrecon.cfg`).
   - **System Permissions**: If not running as root, configure sudo to avoid prompts:
     ```bash
     sudo echo "${USERNAME} ALL=(ALL:ALL) NOPASSWD: ALL" | sudo tee -a /etc/sudoers.d/CSRRrecon
     ```
...
2. **Steps**:
   ...
   cd CSRRrecon
   ./install.sh
   ./CSRRrecon.sh -d target.com -r
   ```

3. **Notes**:
- The `install.sh` script installs dependencies, tools, and configures paths (`GOROOT`, `GOPATH`, `PATH`).
- Set `install_golang=false` in `CSRRrecon.cfg` if Golang is already configured.
...
- Check the [Installation Guide](https://github.com/six2dez/CSRRrecon/wiki/0.-Installation-Guide) for detailed instructions.
...
1. **Pull the Image**:
   ...
   ```bash
   docker pull six2dez/CSRRrecon:main
   ```
...
2. **Run the Container**:
   ...
   ```bash
   docker run -it --rm \
     -v "${PWD}/OutputFolder/:/CSRRrecon/Recon/" \
     six2dez/CSRRrecon:main -d example.com -r
   ```
   ...
   ```bash
   docker run -it --rm \
     -v "${PWD}/domains.txt:/CSRRrecon/domains.txt:ro" \
     -v "${PWD}/OutputFolder/:/CSRRrecon/Recon/" \
     six2dez/CSRRrecon:main -l /CSRRrecon/domains.txt -r
   ```
...
4. **Customization**:
   - Modify the Docker image or build your own; see the [Docker Guide](https://github.com/six2dez/CSRRrecon/wiki/4.-Docker).
...
6. **Health Check**:
   ...
   The Docker image includes a built-in `HEALTHCHECK` that runs `./CSRRrecon.sh --health-check` every 60 seconds. You can also run it manually:

   ```bash
   docker exec <container-id> ./CSRRrecon.sh --health-check
   ```

### Terraform + Ansible

- Deploy CSRRrecon on AWS using Terraform and Ansible.
...
- Network hiccups: Installers hide most command output. If something fails, re-run with `upgrade_tools=true` in `CSRRrecon.cfg`, execute `./install.sh --tools`, or install the missing tool manually (the error will name it).
...
- WHOISXML: set `WHOISXML_API` in `CSRRrecon.cfg` or env var
...
The `CSRRrecon.cfg` file controls the entire execution of CSRRrecon. It allows fine-grained customization of:
...
if git rev-parse --is-inside-work-tree >/dev/null 2>&1; then
	CSRRrecon_version="$(git rev-parse --abbrev-ref HEAD)-$(git describe --tags 2>/dev/null || git rev-parse --short HEAD)"
else
	CSRRrecon_version="standalone"
fi # Fetch current CSRRrecon version
...
INSCOPE=false # Uses inscope tool to filter the scope, requires .scope file in CSRRrecon folder
...
AXIOM_FLEET_NAME="CSRRrecon" # Fleet's prefix name
...
# This is a script on your CSRRrecon host that might prep things your way...
...
FARADAY_WORKSPACE="CSRRrecon" # Faraday workspace

# AI
AI_EXECUTABLE="python3" # Python executable fallback if CSRRrecon_ai venv python is not available
...
AI_PROMPTS_FILE="" # Optional custom prompts file (empty uses CSRRrecon_ai default)
...
AI_ALLOW_MODEL_PULL=false # Allow CSRRrecon_ai to auto-pull missing model
...
**Full Details**: See the [Configuration Guide](https://github.com/six2dez/CSRRrecon/wiki/3.-Configuration-file).

---

## 🚀 Usage

CSRRrecon supports multiple modes and options for flexible reconnaissance. Use the `-h` flag to view the help menu.
...
2. **Recon on Multiple Targets**:
   ...
   ```bash
   ./CSRRrecon.sh -l targets.txt -r -o /path/to/output/
   ```

3. **Deep Recon (VPS Recommended)**:

   ```bash
   ./CSRRrecon.sh -d target.com -r --deep
   ```

4. **Parallel Mode (Faster, requires more RAM)**:

   ```bash
   ./CSRRrecon.sh -d target.com -r --parallel
   ```

5. **Force Sequential Mode**:

   ```bash
   ./CSRRrecon.sh -d target.com -r --no-parallel
   ```
6. **Multi-Domain Recon**:

   ```bash
   ./CSRRrecon.sh -m company -l domains.txt -r
   ```

7. **Axiom Integration**:

   ```bash
   ./CSRRrecon.sh -d target.com -r -v
   ```

8. **Axiom Integration with fleet override**:

   ```bash
   ./CSRRrecon.sh -d target.com -r -v 30
   ```

9. **Full Recon with Attacks (YOLO Mode)**:

   ```bash
   ./CSRRrecon.sh -d target.com -a
   ```
...
11. **Force cache refresh**:
   ```bash
   ./CSRRrecon.sh -d target.com -r --refresh-cache
   ```

12. **Export all report artifacts**:
   ```bash
   ./CSRRrecon.sh -d target.com -r --export all
   ```

13. **Continuous monitoring (every 30m, 48 cycles)**:
   ```bash
   ./CSRRrecon.sh -d target.com -r --monitor --monitor-interval 30 --monitor-cycles 48
   ```

14. **Rebuild reports only (no scan):**
   ```bash
   ./CSRRrecon.sh -d target.com --report-only --export all
   ```

**Full Guide**: See the [Usage Guide](https://github.com/six2dez/CSRRrecon/wiki/2.-Usage-Guide).

---

## ☁️ Ax Framework Support (previously Axiom)

CSRRrecon integrates with [Ax](https://github.com/attacksurge/ax) for distributed scanning, reducing execution time by distributing tasks across multiple cloud instances.

- **Setup**: Select `CSRRrecon` as the provisioner during Axiom configuration.
...
- **Configuration**: Set fleet size, region, and name in `CSRRrecon.cfg` (`AXIOM_FLEET_COUNT`, `AXIOM_FLEET_REGIONS`, `AXIOM_FLEET_NAME`).
...
**Details**: See the [Axiom Guide](https://github.com/six2dez/CSRRrecon/wiki/5.-Axiom-version) and official [Ax Docs](https://ax.attacksurge.com/).

---

## 💻 Faraday Support

CSRRrecon integrates with [Faraday](https://faradaysec.com/) for web-based reporting and vulnerability management.

- **Setup**: Install Faraday, authenticate via `faraday-cli`, and configure the workspace in `CSRRrecon.cfg` (`FARADAY_WORKSPACE`).
- **Usage**: Enable with `FARADAY=true` in `CSRRrecon.cfg`.

---

## 🧠 AI Integration

CSRRrecon uses AI to generate detailed reports from scan results with the tool [CSRRrecon_ai](https://github.com/six2dez/CSRRrecon_ai).
...
- **Structured Output**: `CSRRrecon` stores a machine-readable report in `ai_result/CSRRrecon_analysis.json`.
...
When `ASSET_STORE=true`, CSRRrecon aggregates key findings into `assets.jsonl` during each run, making it easy to sync only actionable deltas to your private repo.
...
1. **Bootstrap**:
   ...
   ```bash
   export PRIV_REPO="$HOME/CSRRrecon-data"
   make bootstrap
   ```
...
4. **Lint / Format Scripts**:
   ...
   ```bash
   make lint   # shellcheck for CSRRrecon.sh, modules/*.sh & install.sh
...
2. Clone and configure:
   ...
   ```bash
   git clone https://github.com/yourusername/CSRRrecon-data
   cd CSRRrecon-data
   git commit --allow-empty -m "Initial commit"
   git remote add upstream https://github.com/six2dez/CSRRrecon
   git fetch upstream
...
CSRRrecon uses [bats-core](https://github.com/bats-core/bats-core) for automated testing.
...
setup() {
    source ./CSRRrecon.sh --source-only
}
...
1. **ShellCheck** — lints `CSRRrecon.sh`, `modules/*.sh`, and `install.sh`
2. **Unit Tests** — runs all `tests/unit/*.bats` files
3. **Integration Tests** — installs CSRRrecon and validates tool availability
...
- [Report a Bug](https://github.com/six2dez/CSRRrecon/issues/new/choose)
- [Submit a Pull Request](https://github.com/six2dez/CSRRrecon/tree/dev) (target the `dev` branch)
...
- **Wiki**: Explore the [CSRRrecon Wiki](https://github.com/six2dez/CSRRrecon/wiki).
- **FAQ**: Check the [FAQ](https://github.com/six2dez/CSRRrecon/wiki/7.-FAQs).
...
Support CSRRrecon’s development through:
...
Special thanks to the following services for supporting CSRRrecon:
...
```
CSRRrecon/
├── CSRRrecon.sh          # Main entry point (~500 lines)
├── CSRRrecon.cfg         # Configuration file
...
# 3. Run health check
./CSRRrecon.sh --health-check

# 4. Dry run to preview
./CSRRrecon.sh -d example.com -r --dry-run
```
...
CSRRrecon is licensed under the [MIT License](LICENSE).

---

## ⭐ Star History

[![Star History Chart](https://api.star-history.com/svg?repos=six2dez/CSRRrecon&type=Date)](https://www.star-history.com/#six2dez/CSRRrecon&Date)
